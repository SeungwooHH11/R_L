    ...
    def Train(self,train_data_num,update_num,train_step_num,eval_step,pr_num,batch_num,K,simulation_day,lookahead_num,ppo,model_dir,ASR_1,Random_1,BLF_1,history_dir):
        ...
        for step in range(train_step_num):
            ...
            for ____ in range(K):
                ...
                ave_loss+=loss
            vessl.log(step=step, payload={'ave_loss': ave_loss/K})
                    #print(loss)
                #print(tr_step)
...
if __name__=="__main__":
    ...
    bpd=(6,7)
    init_block=5
    ST_sim=Stockyard_simulation(yard_size=pr_size,initial_block=init_block,lam=1/250,weight=(100,501),TP_type=[300,550],Block_per_Day=bpd,mod=0)
