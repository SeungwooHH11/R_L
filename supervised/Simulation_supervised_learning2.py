...
if __name__=="__main__":
    ...
    ppo=PPO(feature_dim=4, hidden_dim=32, lookahead_block_num=1,grid_size=(7,7), learning_rate=0.001, lmbda=0.95, gamma=1, alpha=0.5, beta=0.01, epsilon=0.2, mod='GCN1').to(device)
