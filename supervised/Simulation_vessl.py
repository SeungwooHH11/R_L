...
if __name__=="__main__":
    ...
    init_block=10
    bpd=(10,14)
    ST_sim=Stockyard_simulation(yard_size=pr_size,initial_block=init_block,lam=1/250,weight=(100,501),TP_type=[300,400,550],Block_per_Day=bpd,mod=0)
    ...
    '''
    history=ST_sim.Train(train_step=1000,eval_step=20,K=2,pr_num=7,batch_num=20,simulation_day=10,lookahead_num=1,ppo=ppo,model_dir='',ASR_1=ASR_1,Random_1=Random_1,BLF_1=BLF_1)
