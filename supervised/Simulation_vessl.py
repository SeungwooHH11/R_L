...
if __name__=="__main__":
    ...
    '''
    history=ST_sim.Train(train_step=1000,eval_step=20,K=2,pr_num=4,batch_num=13,simulation_day=10,lookahead_num=1,ppo=ppo,model_dir=model_dir,ASR_1=ASR_1,Random_1=Random_1,BLF_1=BLF_1)
