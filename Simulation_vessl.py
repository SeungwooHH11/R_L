...
if __name__=="__main__":
    ...
    ppo=PPO(feature_dim=4, hidden_dim=32, lookahead_block_num=3,grid_size=(5,5), learning_rate=0.001, lmbda=0.95, gamma=1, alpha=1, beta=0.5, epsilon=0.2, mod='MLP').to(device)
