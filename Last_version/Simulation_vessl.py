...
class Stockyard_simulation:
    ...
    def Train(self,train_step,eval_step,K,pr_num,batch_num,simulation_day,lookahead_num,ppo,model_dir,ASR_1,Random_1,BLF_1):
        ...
        for tr_step in range(train_step):
            ...
            for ____ in range(K):
                ave_loss, v_loss, p_loss=ppo.update(gridss[:,:,:,:-1],blockss,actionss,rewardss,doness,maskss,probss,ep_len,tr_step,model_dir)
...
if __name__=="__main__":
    ...
    history=ST_sim.Train(train_step=6000,eval_step=40,K=2,pr_num=10,batch_num=20,simulation_day=10,lookahead_num=1,ppo=ppo,model_dir=model_dir,ASR_1=ASR_1,Random_1=Random_1,BLF_1=BLF_1)
